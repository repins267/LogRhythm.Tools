...
Function Restart-LrAieService {
    <#
    .SYNOPSIS
        Restart the AIE service via the LogRhythm AIE Engine API.
    .DESCRIPTION
        Restart-LrAieService triggers a restart of the AIE engine service.
    .PARAMETER PassThru
    ...
    .OUTPUTS
        Success: No Output.
        PassThru: PSCustomObject representing the restart result.
    .EXAMPLE
        PS C:\> Restart-LrAieService -PassThru
    .NOTES
        LogRhythm-API
    .LINK
    ...
    Process {
        ...
        $RequestUrl = $BaseUrl + "/lr-aie-api/aie/rules/restartService/"
