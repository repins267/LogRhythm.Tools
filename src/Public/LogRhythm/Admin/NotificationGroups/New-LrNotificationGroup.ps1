...
Function New-LrNotificationGroup {
    <#
    .SYNOPSIS
        Create a new notification group in the LogRhythm Admin API.
    .DESCRIPTION
        New-LrNotificationGroup creates a notification group record via the
        Admin API.
    .PARAMETER Name
    ...
    .OUTPUTS
        Success: No Output.
        PassThru: PSCustomObject representing the newly created notification group.
    .EXAMPLE
        PS C:\> New-LrNotificationGroup -Name "SOC Analysts" -PassThru
    .NOTES
        LogRhythm-API
    .LINK
