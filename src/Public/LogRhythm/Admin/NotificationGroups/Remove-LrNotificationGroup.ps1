...
Function Remove-LrNotificationGroup {
    <#
    .SYNOPSIS
        Delete a notification group from the LogRhythm Admin API.
    .DESCRIPTION
        Remove-LrNotificationGroup deletes a notification group record by ID.
    .PARAMETER Id
        The notification group ID to delete.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Remove-LrNotificationGroup -Id 5
    .NOTES
        LogRhythm-API
    .LINK
