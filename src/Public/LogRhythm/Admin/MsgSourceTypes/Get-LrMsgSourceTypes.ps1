...
Function Get-LrMsgSourceTypes {
    <#
    .SYNOPSIS
        Retrieve message source types from the LogRhythm Admin API.
    .DESCRIPTION
        Get-LrMsgSourceTypes returns message source type records with automatic
        pagination support.
    ...
    .OUTPUTS
        PSCustomObject representing LogRhythm message source type records.
    .EXAMPLE
        PS C:\> Get-LrMsgSourceTypes
    .NOTES
        LogRhythm-API
    .LINK
