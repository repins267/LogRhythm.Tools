...
Function Remove-LrMsgSourceType {
    <#
    .SYNOPSIS
        Delete a message source type from the LogRhythm Admin API.
    .DESCRIPTION
        Remove-LrMsgSourceType deletes a message source type record by ID.
    .PARAMETER Id
        The message source type ID to delete.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Remove-LrMsgSourceType -Id 1001
    .NOTES
        LogRhythm-API
    .LINK
