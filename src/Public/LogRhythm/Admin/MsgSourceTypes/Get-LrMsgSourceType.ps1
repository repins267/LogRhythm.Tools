...
Function Get-LrMsgSourceType {
    <#
    .SYNOPSIS
        Retrieve a message source type by ID from the LogRhythm Admin API.
    .DESCRIPTION
        Get-LrMsgSourceType returns a single message source type record.
    .PARAMETER Id
        The message source type ID to retrieve.
    .PARAMETER Credential
        PSCredential containing an API Token in the Password field.
    .OUTPUTS
        PSCustomObject representing the LogRhythm message source type record.
    .EXAMPLE
        PS C:\> Get-LrMsgSourceType -Id 1
    .NOTES
        LogRhythm-API
    .LINK
