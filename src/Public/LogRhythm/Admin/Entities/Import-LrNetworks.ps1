...
Function Import-LrNetworks {
    <#
    .SYNOPSIS
        Import networks for an entity via the LogRhythm Admin API.
    .DESCRIPTION
        Import-LrNetworks uploads a network import file for a specific entity to
        the Admin API.
    .PARAMETER EntityId
        The entity ID to import networks into.
    .PARAMETER FilePath
        The full path to the network import file.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Import-LrNetworks -EntityId 1 -FilePath "C:\imports\networks.csv" -PassThru
    .NOTES
        LogRhythm-API
    .LINK
    ...
    Process {
        ...
        $RequestUrl = $BaseUrl + "/lr-admin-api/entities/" + $EntityId + "/networks/import/"
