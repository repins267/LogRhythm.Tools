...
Function Remove-LrUserProfile {
    <#
    .SYNOPSIS
        Delete a user profile from the LogRhythm Admin API.
    .DESCRIPTION
        Remove-LrUserProfile deletes a user profile record by ID.
    .PARAMETER Id
        The user profile ID to delete.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Remove-LrUserProfile -Id 5
    .NOTES
        LogRhythm-API
    .LINK
