...
Function Get-LrUserLogins {
    <#
    .SYNOPSIS
        Retrieve user logins from the LogRhythm Admin API.
    .DESCRIPTION
        Get-LrUserLogins returns user login records from the Admin API.
    ...
    .OUTPUTS
        PSCustomObject representing LogRhythm user login records.
    .EXAMPLE
        PS C:\> Get-LrUserLogins
    .NOTES
        LogRhythm-API
    .LINK
    ...
    Process {
        ...
        $RequestUrl = $BaseUrl + "/lr-admin-api/users/user-logins/" + $QueryString
