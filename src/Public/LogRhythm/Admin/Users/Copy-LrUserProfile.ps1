...
Function Copy-LrUserProfile {
    <#
    .SYNOPSIS
        Clone an existing user profile in the LogRhythm Admin API.
    .DESCRIPTION
        Copy-LrUserProfile creates a copy of an existing user profile by ID,
        including all associated privileges and settings.
    .PARAMETER Id
        The user profile ID to clone.
    .PARAMETER PassThru
    ...
    .OUTPUTS
        Success: No Output.
        PassThru: PSCustomObject representing the newly cloned user profile.
    .EXAMPLE
        PS C:\> Copy-LrUserProfile -Id 1 -PassThru
    .NOTES
        LogRhythm-API
    .LINK
