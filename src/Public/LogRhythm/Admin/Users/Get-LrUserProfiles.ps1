...
Function Get-LrUserProfiles {
    <#
    .SYNOPSIS
        Retrieve user profiles from the LogRhythm Admin API.
    .DESCRIPTION
        Get-LrUserProfiles returns user profile records with automatic
        pagination support.
    .PARAMETER Name
        Filter results by profile name.
    ...
    .OUTPUTS
        PSCustomObject representing LogRhythm user profile records.
    .EXAMPLE
        PS C:\> Get-LrUserProfiles
    .EXAMPLE
        PS C:\> Get-LrUserProfiles -Name "Admin"
    .NOTES
        LogRhythm-API
    .LINK
