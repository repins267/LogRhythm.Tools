...
Function Get-LrAdminUser {
    <#
    .SYNOPSIS
        Retrieve a person by ID from the LogRhythm Admin API.
    .DESCRIPTION
        Get-LrAdminUser returns a single person record from the Admin API.
    .PARAMETER Id
        The person ID to retrieve.
    .PARAMETER Credential
        PSCredential containing an API Token in the Password field.
    .OUTPUTS
        PSCustomObject representing the LogRhythm Admin person record.
    .EXAMPLE
        PS C:\> Get-LrAdminUser -Id 1
    .NOTES
        LogRhythm-API
    .LINK
