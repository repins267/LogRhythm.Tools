...
Function Remove-LrHostRole {
    <#
    .SYNOPSIS
        Remove a role from a host record in the LogRhythm Admin API.
    .DESCRIPTION
        Remove-LrHostRole removes a role assignment from an existing host by
        host ID.
    .PARAMETER Id
        The host ID to remove the role from.
    .PARAMETER RoleName
    ...
    .EXAMPLE
        PS C:\> Remove-LrHostRole -Id 2 -RoleName "Mediator" -PassThru
    .NOTES
        LogRhythm-API
    .LINK
