...
Function Get-LrBeats {
    <#
    .SYNOPSIS
        Retrieve a list of Beats from LogRhythm.
    .DESCRIPTION
        Get-LrBeats returns all beats details available in the system.
    .PARAMETER Name
        Filter results by beat name.
    ...
    .OUTPUTS
        PSCustomObject representing LogRhythm Beat records.
    .EXAMPLE
        PS C:\> Get-LrBeats
        ---
        Returns all beats.
    .EXAMPLE
        PS C:\> Get-LrBeats -Name "Syslog"
        ---
        Returns beats matching "Syslog".
    .NOTES
        LogRhythm-API
    .LINK
    ...
    Process {
        ...
        # Request URL
        $RequestUrl = $BaseUrl + "/lr-admin-api/beats/" + $QueryString
