...
Function Get-LrMpePolicyRules {
    <#
    .SYNOPSIS
        Retrieve MPE Rules associated with an MPE Policy.
    .DESCRIPTION
        Get-LrMpePolicyRules returns the MPE Rules associated to an MPE Policy
        based on the provided MPE Policy ID.
    .PARAMETER Id
        The MPE Policy ID to retrieve associated rules for.
    .PARAMETER PageValuesCount
        Integer representing the number of results per page. Default is 1000.
    .PARAMETER PageCount
        Integer representing the page number to return. Default is 1.
    .PARAMETER Credential
        PSCredential containing an API Token in the Password field.
    .OUTPUTS
        PSCustomObject representing LogRhythm MPE Rules associated with the policy.
    .EXAMPLE
        PS C:\> Get-LrMpePolicyRules -Id 5
        ---
        Returns all MPE Rules associated with MPE Policy ID 5.
    .NOTES
        LogRhythm-API
    .LINK
