...
Function Get-LrMpePoliciesSummary {
    <#
    .SYNOPSIS
        Retrieve a summary list of MPE Policies from LogRhythm.
    .DESCRIPTION
        Get-LrMpePoliciesSummary returns a lightweight summary of MPE Policies
        from the LogRhythm Admin API.
    ...
    .OUTPUTS
        PSCustomObject representing LogRhythm MPE Policy summaries.
    .EXAMPLE
        PS C:\> Get-LrMpePoliciesSummary
        ---
        Returns all MPE Policy summaries.
    .NOTES
        LogRhythm-API
    .LINK
    ...
    Process {
        ...
        # Request URL
        $RequestUrl = $BaseUrl + "/lr-admin-api/mpepolicies/summary/" + $QueryString
