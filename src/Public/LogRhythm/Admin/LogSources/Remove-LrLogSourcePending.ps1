...
Function Remove-LrLogSourcePending {
    <#
    .SYNOPSIS
        Delete a Pending Log Source from LogRhythm.
    .DESCRIPTION
        Remove-LrLogSourcePending deletes a pending log source by ID.
    .PARAMETER Id
        The pending log source ID to delete.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Remove-LrLogSourcePending -Id 110
        ---
        Deletes pending log source with ID 110.
    .NOTES
        LogRhythm-API
    .LINK
