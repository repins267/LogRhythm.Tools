...
Function Deny-LrLogSourcePending {
    <#
    .SYNOPSIS
        Reject a Pending Log Source in LogRhythm.
    .DESCRIPTION
        Deny-LrLogSourcePending rejects a single pending log source by ID.
    .PARAMETER Id
        The pending log source ID to reject.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Deny-LrLogSourcePending -Id 110
        ---
        Rejects pending log source 110.
    .NOTES
        LogRhythm-API
    .LINK
