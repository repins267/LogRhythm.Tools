...
Function Approve-LrLogSourcesPending {
    <#
    .SYNOPSIS
        Accept multiple Pending Log Sources in batch in LogRhythm.
    .DESCRIPTION
        Approve-LrLogSourcesPending accepts multiple pending log sources
        by submitting a batch PUT request with an array of IDs.
    .PARAMETER Id
        One or more pending log source IDs to accept. Accepts pipeline input.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Approve-LrLogSourcesPending -Id 110, 111, 112 -PassThru
        ---
        Accepts pending log sources 110, 111, and 112 in batch.
    .NOTES
        LogRhythm-API
    .LINK
