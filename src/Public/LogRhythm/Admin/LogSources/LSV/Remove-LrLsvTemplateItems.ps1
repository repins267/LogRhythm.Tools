...
Function Remove-LrLsvTemplateItems {
    <#
    .SYNOPSIS
        Delete items from a Log Source Virtualization template.
    .DESCRIPTION
        Remove-LrLsvTemplateItems deletes one or more LSV template items
        by submitting a DELETE request with an array of item IDs.
    .PARAMETER TemplateId
        The LSV Template ID containing the items.
    .PARAMETER ItemId
        One or more LSV Template Item IDs to delete.
    .PARAMETER PassThru
    ...
    .EXAMPLE
        PS C:\> Remove-LrLsvTemplateItems -TemplateId 5 -ItemId 10, 11, 12
        ---
        Deletes items 10, 11, and 12 from LSV Template 5.
    .NOTES
        LogRhythm-API
    .LINK
