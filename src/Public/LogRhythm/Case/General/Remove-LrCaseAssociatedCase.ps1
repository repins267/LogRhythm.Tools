...
Function Remove-LrCaseAssociatedCase {
    <#
    .SYNOPSIS
        Remove an assocaited case to a LogRhythm case.
    .DESCRIPTION
        The Remove-LrCaseAssociatedCase cmdlet removes a case as an association to an existing case.
