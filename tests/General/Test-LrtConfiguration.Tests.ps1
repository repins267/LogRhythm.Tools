Describe "LogRhythm.Tools: Test-LrtConfiguration" -Tag 'Unit' {
    BeforeAll {
    ...
    Context "Input validation" {
        It "Should have CmdletBinding attribute" {
            (Get-Command Test-LrtConfiguration).CmdletBinding | Should -BeTrue
        }

        It "Should have optional Service parameter" {
            $param = (Get-Command Test-LrtConfiguration).Parameters['Service']
            $param | Should -Not -BeNullOrEmpty
            $param.Attributes.Mandatory | Should -Not -BeTrue
        }

        It "Should have TestConnectivity switch parameter" {
            $param = (Get-Command Test-LrtConfiguration).Parameters['TestConnectivity']
            $param | Should -Not -BeNullOrEmpty
